...
def write_graph_trace(Graph, file_name):
    ...
    file = open("../traces/G1-Graphe" + file_name + "-result.txt", "w+", encoding="UTF-8")
    ...
    print("\nLa trace du graphe " + file_name + " a ete ecrite dans le fichier /traces/G1-Graphe" + file_name + "-result.txt.\n")
    file.close()
